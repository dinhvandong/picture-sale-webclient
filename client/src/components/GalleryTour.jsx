...
const GalleryTour = () => {
    return (
        <div></div>
        // <div className='flex flex-col items-center w-full p-5 text-white bg-black'>
        //     <div className='w-[100%] flex flex-col p-5 bg-black text-white'>

        //         <div>
        //             <p className='font-bold text-yellow-500'>Chat with our Special Vietnamese Artist of Nguyen Art Gallery – A Memorable Experience about Fine Arts
        //             </p>

        //             <p>Duration: 2 hours</p>
        //             <p>Meeting place: Nguyen Art Gallery – 31A Van Mieu street, Dong Da District, Hanoi</p>
        //             <p>Morning Tour: Start at 9AM</p>
        //             <p>Afternoon tour: Start at 2PM</p>
        //             <p>Art Collector: Mr. Henry Le</p>
        //         </div>
        //         <div>
        //             <p className='font-bold text-yellow-500'>General Introduction
        //             </p>
        ...
        //                     <p className='font-bold text-yellow-500'>What Makes This Experience Different?
        //                     </p>
        //                     <p>
        ...
        //                     </p>
        //                     <p>
        //                         Luxury services with Hi-ends hospitalities.

        //                     </p>
        //                 </div>
        //                 <div className='w-full mr-5'>

        //                     <img className='w-full h-auto' src='https://www.nguyenartgallery.com/wp-content/uploads/benefits-chatting-with-our-art-collector.jpg' />
        //                 </div>
        //                 <div className='w-full mr-5'>
        //                     <p className='font-bold text-yellow-500'>What Makes This Experience Different?
        //                     </p>
