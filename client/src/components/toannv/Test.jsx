  ...
  return (
    <div className='flex flex-col w-full h-max'>
      ...
      <div className='flex flex-col items-center w-full h-max bg-[#27242E]'>
        ...
        <p className='m-1 leading-none text-white'>Vietnamese paintings of landscapes at Nguyen Art Gallery include beaches, mountains, flora, and countryside. The physical elements of landforms in Vietnam combine with others</p>
        <p className='m-1 leading-none text-white'>help artists compose a number of scenes from rugged, peaceful to romantic paintings. Cultural differences may affect the way people perceive these artworks. Do not worry, NAGs</p>
        <p className='m-1 leading-none text-white'>collection of landscape paintings brings a wide variety of styles, materials, and dimensions so that there is something for everyones tastes.</p>
            ...
            <div className='flex items-center justify-center w-1/2 h-full p-3'>
              <div className='w-full h-[70%] flex flex-col'>
                <div className='w-full h-[20%] flex flex-col items-center justify-center'>
                  <span className='text-[#FFEF96] m-1 leading-none font-bold text-[25px]'>Complete Your Collection with Our</span>
                  <span className='text-[#FFEF96] m-1 leading-none font-bold text-[25px]'>Sophisticated Landscape Paintings</span>
                </div>
                <div className='w-full h-[80%] mt-4 flex flex-col justify-center'>
                  <p className='m-1 font-bold leading-none text-white'>The old quarter has always been one of the favorite</p>
                  <p className='m-1 font-bold leading-none text-white'>themes in paintings of Vietnamese artists. The artworks</p>
                  <p className='m-1 font-bold leading-none text-white'>of streets in Vietnam not only create a vibrant ambiance</p>
                  <p className='m-1 font-bold leading-none text-white'>for your living space but help you find inner peace in your</p>
                  <p className='m-1 font-bold leading-none text-white'>life.</p>
                  <p className='m-1 mt-3 leading-none text-white'>With a collection of street paintings of more than 75</p>
                  <p className='m-1 font-bold leading-none text-white'>artworks by famous Vietnamese Artists, you will have</p>
                  <p className='m-1 font-bold leading-none text-white'>various choices to select one that suits you most.</p>
                </div>
              </div>
            </div>
          ...
          <div className='flex flex-row w-full h-1/2'>
            ...
            <div className='flex items-center justify-center w-1/2 h-full p-3'>
              <div className='w-full h-[70%] flex flex-col'>
                ...
                <div className='w-full h-[80%] mt-4 flex flex-col justify-center'>
                  <p className='m-1 font-bold leading-none text-white'>Using familiar materials such as lacquer and oil paint</p>
                  <p className='m-1 font-bold leading-none text-white'>combined with ingenious brushstrokes, our landscape</p>
                  <p className='m-1 font-bold leading-none text-white'>paintings by famous Vietnamese artists will give you one</p>
                  <p className='m-1 font-bold leading-none text-white'>step closer to nature. Temporarily steer away from the</p>
                  <p className='m-1 font-bold leading-none text-white'>pressure of life and enjoy the pure and untouched beauty</p>
                  <p className='m-1 font-bold leading-none text-white'>of villages, mountains, and rivers from one of our</p>
                  <p className='m-1 font-bold leading-none text-white'>landscape paintings, it is no doubt that your living space</p>
                  <p className='m-1 font-bold leading-none text-white'>will brighten up and be more stunning than it has ever</p>
                  <p className='m-1 font-bold leading-none text-white'>been.</p>
                </div>
              </div>
            </div>
          </div>
